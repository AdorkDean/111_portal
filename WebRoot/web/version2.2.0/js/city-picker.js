    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="' +
                    this.getWidthStyle(405) + 'height:' +
                    34 + 'px;line-height:' + (34 - 1) + 'px;">' +
                    (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                    '<span class="title"></span><div class="arrow"></div>' + '</span>',

                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    this.getWidthStyle(500, true) + '">' +
        ...
        getProvinceList: function (data) {
            ...
            $.each(data, function (i, n) {
                ...
                list.push('<dt style="width:2.5em;">' + i + '</dt><dd>');
                $.each(n, function (j, m) {
                    list.push(
                        '<a  onclick="javascript:getAreaId('+m.code+')"' +
                        ' title="' + (m.address || '') + '"' +
                        ' data-code="' + (m.code || '') + '"' +
                        ' class="' +
                        (m.selected ? ' active' : '') +
        ...
        getList: function (data, type) {
            ...
            $.each(data, function (i, n) {
                list.push(
                    '<a onclick="javascript:getAreaId('+n.code+')"' +
                    ' title="' + (n.address || '') + '"' +
                    ' data-code="' + (n.code || '') + '"' +
                    ' class="' +
                    (n.selected ? ' active' : '') +
