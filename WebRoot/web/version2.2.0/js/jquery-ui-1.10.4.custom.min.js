(function(t, e) {
    ...
    t.widget.bridge = function(i, n) {
        ...
        t.fn[i] = function(o) {
            ...
            l = this;
            return o = !r && h.length ? t.widget.extend.apply(null, [o].concat(h)) : o,
    ...
    t.fn.position = function(e) {
        ...
        this.each(function() {
            ...
            C = d + _ + s(this, "marginBottom") + x.height,
            T = t.extend({},
            v),
    ...
    t.ui.position = {
        ...
        flip: {
            ...
            top: function(t, e) {
                ...
                m = -2 * e.offset[1];
                0 > u ? (s = t.top + p + f + m + e.collisionHeight - o - a, t.top + p + f + m > u && (0 > s || r(u) > s) && (t.top += p + f + m)) : c > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - l, t.top + p + f + m > c && (i > 0 || c > r(i)) && (t.top += p + f + m))
            }
        },
        flipfit: {
            left: function() {
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i) {
            var s, n, a, o, r, l, h, u, c, d, p = t(this).data("ui-draggable"),
            f = p.options,
            m = f.snapTolerance,
            g = i.offset.left,
            ...
            r - m > v || g > l + m || h - m > b || _ > u + m || !t.contains(p.snapElements[c].item.ownerDocument, p.snapElements[c].item) ? (p.snapElements[c].snapping && p.options.snap.release && p.options.snap.release.call(p.element, e, t.extend(p._uiHash(), {
                snapItem: p.snapElements[c].item
            })), p.snapElements[c].snapping = !1) : ("inner" !== f.snapMode && (s = m >= Math.abs(h - b), n = m >= Math.abs(u - _), a = m >= Math.abs(r - v), o = m >= Math.abs(l - g), s && (i.position.top = p._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left - p.margins.left)), d = s || n || a || o, "outer" !== f.snapMode && (s = m >= Math.abs(h - _), n = m >= Math.abs(u - b), a = m >= Math.abs(r - g), o = m >= Math.abs(l - v), s && (i.position.top = p._convertPositionTo("relative", {
                top: h,
                left: 0
            }).top - p.margins.top), n && (i.position.top = p._convertPositionTo("relative", {
            ...
            }).left - p.margins.left)), !p.snapElements[c].snapping && (s || n || a || o || d) && p.options.snap.snap && p.options.snap.snap.call(p.element, e, t.extend(p._uiHash(), {
                snapItem: p.snapElements[c].item
    ...
    t.ui.intersect = function(t, i, s) {
        ...
        case "intersect":
            return o + t.helperProportions.width / 2 > u && d > l - t.helperProportions.width / 2 && r + t.helperProportions.height / 2 > c && p > h - t.helperProportions.height / 2;
        case "pointer":
            ...
            e(a, c, i.proportions().height) && e(n, u, i.proportions().width);
        case "touch":
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _respectSize: function(t) {
            ...
            o && u && (t.left = h - e.minWidth),
            n && u && (t.left = h - e.maxWidth),
            r && c && (t.top = l - e.minHeight),
            a && c && (t.top = l - e.maxHeight),
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _getItemsAsjQuery: function(e) {
            ...
            h = [],
            l = this._connectWith();
            if (l && e) for (s = l.length - 1; s >= 0; s--) for (a = t(l[s]), n = a.length - 1; n >= 0; n--) o = t.data(a[n], this.widgetFullName),
        ...
        _create: function() {
            ...
            this._on(this.menu.element, {
                ...
                menuselect: function(t, e) {
                    ...
                    this.close(t),
                    this.selectedItem = i
                    putKeyWordsInCookies(this._value());
    ...
    t.widget("ui.button", {
        ...
        _create: function() {
            ...
            function() {
                return o.disabled ? !1 : (t(this).addClass("ui-state-active"), e = this, s.document.one("mouseup",
                function() {
                    e = null
                }), undefined)
    ...
    t.extend(i.prototype, {
        ...
        _dialogDatepicker: function(e, i, s, a, r) {
            ...
            this._pos || (l = document.documentElement.clientWidth, u = document.documentElement.clientHeight, c = document.documentElement.scrollLeft || document.body.scrollLeft, d = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [l / 2 - 100 + c, u / 2 - 150 + d]),
        ...
        _optionDatepicker: function(i, s, a) {
            ...
            t.datepicker._defaults) : u ? "all" === s ? t.extend({},
            u.settings) : this._get(u, s) : null: (o = s || {},
            "string" == typeof s && (o = {},
            o[s] = a), u && (this._curInst === u && this._hideDatepicker(), r = this._getDateDatepicker(i, !0), h = this._getMinMaxDate(u, "min"), l = this._getMinMaxDate(u, "max"), n(u.settings, o), null !== h && o.dateFormat !== e && o.minDate === e && (u.settings.minDate = this._formatDate(u, h)), null !== l && o.dateFormat !== e && o.maxDate === e && (u.settings.maxDate = this._formatDate(u, l)), "disabled" in o && (o.disabled ? this._disableDatepicker(i) : this._enableDatepicker(i)), this._attachments(t(i), u), this._autoSize(u), this._setDate(u, r), this._updateAlternate(u), this._updateDatepicker(u)), e)
        },
        ...
        parseDate: function(i, s, n) {
            ...
            case "@":
                ...
                break;
            case "!":
                h = new Date((w("!") - this._ticksTo1970) / 1e4),
                g = h.getFullYear(),
                v = h.getMonth() + 1,
                _ = h.getDate();
                break;
        ...
        formatDate: function(t, e, i) {
            ...
            c = "",
            d = !1;
            if (e) for (s = 0; t.length > s; s++) if (d)"'" !== t.charAt(s) || h("'") ? c += t.charAt(s) : d = !1;
        ...
        _generateHTML: function(t) {
            var e, i, s, n, a, o, r, h, l, u, c, d, p, f, m, g, v, _, b, y, x, w, k, D, C, T, M, S, N, I, P, A, H, E, O, F, z, W, L, R = new Date,
                ...
                for (k = "", this.maxRows = 4, D = 0; J[1] > D; D++) {
                    if (C = this._daylightSavingAdjust(new Date(te, Z, t.selectedDay)), T = " ui-corner-all", M = "", G) {
                        ...
                        case 0:
                            ...
                            break;
                        case J[1] - 1 : M += " ui-datepicker-group-last",
                    ...
                    for (M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === w ? Y ? a: s: "") + (/all|right/.test(T) && 0 === w ? Y ? s: a: "") + this._generateMonthYearHeader(t, Z, te, $, Q, w > 0 || D > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>", S = c ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>": "", x = 0; 7 > x; x++) N = (x + u) % 7,
                    S += "<th" + ((x + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'": "") + ">" + "<span title='" + d[N] + "'>" + p[N] + "</span></th>";
                    for (M += S + "</tr></thead><tbody>", I = this._getDaysInMonth(te, Z), te === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, I)), P = (this._getFirstDayOfMonth(te, Z) - u + 7) % 7, A = Math.ceil((P + I) / 7), H = G ? this.maxRows > A ? this.maxRows: A: A, this.maxRows = H, E = this._daylightSavingAdjust(new Date(te, Z, 1 - P)), O = 0; H > O; O++) {
                        for (M += "<tr>", F = c ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(E) + "</td>": "", x = 0; 7 > x; x++) z = g ? g.apply(t.input ? t.input[0] : null, [E]) : [!0, ""],
                        W = E.getMonth() !== Z,
                        L = W && !_ || !z[0] || $ && $ > E || Q && E > Q,
                        F += "<td class='" + ((x + u + 6) % 7 >= 5 ? " ui-datepicker-week-end": "") + (W ? " ui-datepicker-other-month": "") + (E.getTime() === C.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === E.getTime() && b.getTime() === C.getTime() ? " " + this._dayOverClass: "") + (L ? " " + this._unselectableClass + " ui-state-disabled": "") + (W && !v ? "": " " + z[1] + (E.getTime() === X.getTime() ? " " + this._currentClass: "") + (E.getTime() === j.getTime() ? " ui-datepicker-today": "")) + "'" + (W && !v || !z[2] ? "": " title='" + z[2].replace(/'/g, "&#39;") + "'") + (L ? "": " data-handler='selectDay' data-event='click' data-month='" + E.getMonth() + "' data-year='" + E.getFullYear() + "'") + ">" + (W && !v ? "&#xa0;": L ? "<span class='ui-state-default'>" + E.getDate() + "</span>": "<a class='ui-state-default" + (E.getTime() === j.getTime() ? " ui-state-highlight": "") + (E.getTime() === X.getTime() ? " ui-state-active": "") + (W ? " ui-priority-secondary": "") + "' href='#'>" + E.getDate() + "</a>") + "</td>",
                    ...
                    Z++,
                    Z > 11 && (Z = 0, te++),
                    M += "</tbody></table>" + (G ? "</div>" + (J[0] > 0 && D === J[1] - 1 ? "<div class='ui-datepicker-row-break'></div>": "") : ""),
                    k += M
                }
                y += k
            }
    ...
    function(t, e) {
        ...
        h.fn = t.extend(h.prototype, {
            parse: function(n, o, r, l) {
                ...
                "string" === d ? this.parse(s(n) || a._default) : "array" === d ? (f(u.rgba.props,
                function(t, e) {
                    p[e.idx] = i(n[e.idx], e)
                }), this) : "object" === d ? (n instanceof h ? f(u,
                function(t, e) {
    ...
    t.effects.effect.blind = function(s, n) {
        ...
        u = t.effects.setMode(l, s.mode || "hide"),
        c = s.direction || "up",
        d = e.test(c),
        p = d ? "height": "width",
        f = d ? "top": "left",
    ...
    t.effects.effect.bounce = function(e, i) {
        ...
        a[v] = 0, o.css("opacity", 0).css(v, _ ? 2 * -d: 2 * d).animate(a, m, g)), h && (d /= Math.pow(2, p - 1)), a = {},
        a[v] = 0, s = 0; p > s; s++) n = {},
        n[v] = (_ ? "-=": "+=") + d,
    ...
    t.effects.effect.explode = function(e, i) {
        ...
        b = [];
        for (a = 0; c > a; a++) for (l = g.top + a * _, u = a - (c - 1) / 2, o = 0; d > o; o++) r = g.left + o * v,
        h = o - (d - 1) / 2,
    ...
    t.effects.effect.fold = function(e, i) {
        ...
        c && (u = parseInt(c[1], 10) / 100 * n[h ? 0 : 1]),
        l && s.css(d ? {
            height: 0,
            width: u
        }: {
    ...
    t.effects.effect.pulsate = function(e, i) {
        ...
        d = n.queue(),
        p = d.length;
        for ((o || !n.is(":visible")) && (n.css("opacity", 0).show(), c = 1), s = 1; h > s; s++) n.animate({
            opacity: c
        },
        u, e.easing),
        c = 1 - c;
    ...
    t.effects.effect.size = function(e, i) {
        ...
        ("box" === m || "both" === m) && (a.from.y !== a.to.y && (_ = _.concat(c), o.from = t.effects.setTransition(o, c, a.from.y, o.from), o.to = t.effects.setTransition(o, c, a.to.y, o.to)), a.from.x !== a.to.x && (_ = _.concat(d), o.from = t.effects.setTransition(o, d, a.from.x, o.from), o.to = t.effects.setTransition(o, d, a.to.x, o.to))),
        ("content" === m || "both" === m) && a.from.y !== a.to.y && (_ = _.concat(u).concat(l), o.from = t.effects.setTransition(o, u, a.from.y, o.from), o.to = t.effects.setTransition(o, u, a.to.y, o.to)),
        t.effects.save(o, _),
        o.show(),
        ...
        o.css(o.from),
        ("content" === m || "both" === m) && (c = c.concat(["marginTop", "marginBottom"]).concat(u), d = d.concat(["marginLeft", "marginRight"]), l = r.concat(c).concat(d), o.find("*[width]").each(function() {
            var i = t(this),
            s = {
                height: i.height(),
                width: i.width(),
