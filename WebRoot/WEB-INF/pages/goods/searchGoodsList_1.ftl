    ...
    <div class="list-box">
    	<div class="w1090 clearfix clear">
            ...
            <div class="location-bread clearfix">
                    ...
                    <em>&gt;</em>
                   <a href="${base}/${keyword?default('')}/slist.html"><span class="location-curr">${keyword?default('')}</span></a>
            </div>
            <!--面包屑导航结束-->
            ...
            <!--商品列表开始-->
            			...
            			<p class="red">抱歉，没有找到“${keyword?default('')}”的搜索结果，为您推荐以下商品。</p>
		            </div>
			            <style>
			            .without-result{padding:20px 0; font-size:14px;}
			            </style>
						</#if>
        ...
        <!-- 左右滚动部分 begin -->
        <div class="relevant-product relevant-product2 w1090" style="margin-top: 10px;">
