...
<!--style-->
    ...
    <div class="w1210 mt10">
		<div class="product-box">
					...
					<div class="product-relevant">
                    	<div class="product-screening clearfix clear">
                        	...
                        	<div class="location-bread clearfix">
                            	...
                            	<a href="${base}/${resc.id?default()}/list.html">${resc.categoryName?default('')}</a>
                                ...
                                <div class="filter-main">
                                	<div class="filter-list-type one-line clearfix">
                                        <ul class="clearfix clear">
                                            <li><a href="${base}/${Url_A?default('')}/list${Url_F?default('')}${brandid?default('')}${Url_G?default('')}${pricea?default('')}${Url_H?default('')}${priceb?default('')}${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" <#if type?default('')==''>class="curr"</#if>>全部</a></li>
                                            <li><a href="${base}/${Url_A?default('')}/list-d1${Url_F?default('')}${brandid?default('')}${Url_G?default('')}${pricea?default('')}${Url_H?default('')}${priceb?default('')}${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" <#if type?default('')=='1'>class="curr"</#if>>OTC</a></li>
                                            <li><a href="${base}/${Url_A?default('')}/list-d2${Url_F?default('')}${brandid?default('')}${Url_G?default('')}${pricea?default('')}${Url_H?default('')}${priceb?default('')}${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" <#if type?default('')=='2'>class="curr"</#if>>处方药</a></li>
                                            <li><a href="${base}/${Url_A?default('')}/list-d3${Url_F?default('')}${brandid?default('')}${Url_G?default('')}${pricea?default('')}${Url_H?default('')}${priceb?default('')}${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" <#if type?default('')=='3'>class="curr"</#if>>非药品</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="filter-main">
                                	<div class="filter-list-type multi-line clearfix">
                                        <ul class="for-count clearfix clear" id="brandId">
                                            <li><a href="${base}/${Url_A?default('')}/list${Url_E?default('')}${type?default('')}${Url_G?default('')}${pricea?default('')}${Url_H?default('')}${priceb?default('')}${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" <#if brandid?default('')==''>class="curr"</#if>>全部</a></li>
                                            <#list brandList?if_exists as resc>
                                            <li><a id="${resc.id?default('')}" href="${base}/${Url_A?default('')}/list${Url_E?default('')}${type?default('')}-e${resc.id?default('')}${Url_G?default('')}${pricea?default('')}${Url_H?default('')}${priceb?default('')}${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" >${resc.brand_name?default('')}</a></li>
                                            </#list>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="filter-main">
                                	<div class="filter-list-type one-line clearfix">
                                        <ul class="price-filter-list clearfix"  id="priceRange1">
                                            <li><a href="${base}/${Url_A?default('')}/list${Url_E?default('')}${type?default('')}${Url_F?default('')}${brandid?default('')}${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" <#if pricea?default('')==''&&priceb?default('')==''>class="curr"</#if>>全部</a></li>
                                            <li><a href="${base}/${Url_A?default('')}/list${Url_E?default('')}${type?default('')}${Url_F?default('')}${brandid?default('')}-f0-g40${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" id="0|40">0-40元</a></li>
                                            <li><a href="${base}/${Url_A?default('')}/list${Url_E?default('')}${type?default('')}${Url_F?default('')}${brandid?default('')}-f40-g100${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" id="40|100">40-100元</a></li>
                                            <li><a href="${base}/${Url_A?default('')}/list${Url_E?default('')}${type?default('')}${Url_F?default('')}${brandid?default('')}-f100-g200${Url_I?default('')}${sort?default('')}${Url_J?default('')}${orderby?default('')}.html" id="100|200">100-200元</a></li>
                                        </ul>
                                    	...
                                    	<#list pw.result?if_exists as resc>
                                        	...
                                        	<#elseif resc.type?default(0)==1>
                                            	...
                                            	<a class="product-list-link" title="${resc.goods_name?default('')}" target="_blank" href="${base}/p/${resc.id?default()}.html">
                                                	...
                                                	<#--
                                                	<img src="http://ui.111yao.com/upload/image/201411/5ec340ed-1a84-478c-b17e-b610f73d032d-large.jpg" />
                                                	-->
            ...
            <#assign id3=0>
            <#list cate1List?if_exists as resc>
				<#if resc.level?default()==2>
				 <#assign id1=resc.id?default(0)>
				</#if>            
				<#if resc.level?default()==3>
				 <#assign id2=resc.id?default(0)>
				</#if>     
				<#if resc.level?default()==4>
				 <#assign id3=resc.id?default(0)>
				</#if>         
            </#list>
			<div class="product-sub">
				...
				<#if cate.categoryLevel?default(1)==1&&cate.id?default(0)==1>
					<#assign fid=cate.id?default(0)>
                	<div class="product-tree-list">
                	<#if id1?default(0)!=0>
                    	<a href="${base}/${cate.id?default()}/list.html"><h2 class="product-sider-title">${cate.categoryName?default('')}</h2></a>
                        <div class="product-tree-list-main">
                        	...
                        	<#list cateList?if_exists as cate1>
                        		...
                        		<#if id2?default(0)!=0>
                        		<#if cate1.id?default(0)==id1?default(0)>
                                <li><a href="${base}/${cate1.id?default()}/list.html"><span>${cate1.categoryName?default('')}</span></a>
                                    <ul>
                                    <#list cateList?if_exists as cate2>
                                    	...
                                    	<#if id3?default(0)!=0>
                                    	<#if cate2.id?default(0)==id2?default(0)>
                                        <li><a href="${base}/${cate2.id?default()}/list.html"><span>${cate2.categoryName?default('')}</span></a>
                                            <ul>
                                            	<#list cateList?if_exists as cate3>
                                            	<#if cate3.categoryLevel?default(0)==4&&cate3.parentId?default(0)==tid>
                                                <li><a href="${base}/${cate3.id?default()}/list.html"><span>${cate3.categoryName?default('')}</span></a>
                                                </li>
                                                </#if>
                                                </#list>
                                            </ul>
...
<script type="text/javascript" src="${base}/web/js/list/catefirst.js"></script>
