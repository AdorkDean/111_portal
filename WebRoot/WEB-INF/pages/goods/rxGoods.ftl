    ...
    <div class="product-box">
    	...
    	<div class="details-info">
                ...
                <div class="details-box w1210 clearfix clear" style="width:1000px;">
                  ...
                  <div class="details-info-text">
                  	<div class="add-list-fk">
	                    ...
	                    <img class="rx-app-img" src="http://img.zdfei.com/static/image/temp/20160316/ec488424046457efa3c8de68077aace2.png"/>
                    </div>
                	...
                	<div class="pay-way-show" id="pay-way-show">
                    	<dl class="clearfix clear">
                        	<dt>提&nbsp;&nbsp;&nbsp;示：提交需求后药师将在一小时内与您电话联系；本品为处方药，需线下凭处方购买。</dt>
                        </dl>
                    </div>
                  <!--RX透明图层-->  
            ...
            <div class="w1210 mt10 rxnewcontent" style="width:1000px;">
            	<img class="rx-doc-img" src="http://img.zdfei.com/static/image/temp/20160317/e2587e941533c6b24a1f0526817ce65c.png"/>
            	<div class="product-box">
                    <!--右侧主体开始-->
                                    ...
                                    <div id="tab">
                                        <div class="product-list-title clearfix clear" id="rx-product-list-title">
                                            <ul class="product-list-tag clearfix" id="tab-hd3">
                                                ...
                                                <li onclick="RX.selectCon(this,2)">荣誉资质</li>
                                                <li onclick="RX.selectCon(this,3)">相关问答</li>
                                            </ul>
                                        </div>
                                        <div class="clearfix clear" id="tab-bd3">
                                            ...
                                            <div class="recommend-combination clearfix clear" id="rx-instroduce">
                                            	...
                                            	<div class="tip-rx-info"><img src="http://img.zdfei.com/static/image/temp/20160317/ee4b922701c47cc2eb6474a610781afe.jpg"/></div>
                                                ...
                                                <div class="advantage-rx-info"><img src="http://img.zdfei.com/static/image/temp/20160317/68df009294a4df212eed052d49ef7b15.jpg"/></div>
                                            </div>
                                            <!--商品介绍结束-->
