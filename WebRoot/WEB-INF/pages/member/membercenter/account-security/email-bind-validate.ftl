...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${base}/web/css/membercenterlogin.css"/>
    -->
...
<script>
	...
	$("#btn-next").click(function(){
		...
		$.ajax({
		 ...
		 window.location.href = "${base}/member/memberCenter!toEmailBindInput.action?randomUUID="+randomUUID;
