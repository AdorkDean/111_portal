...
<style>
	...
	.order-title,.address-wrap{
		width:1000px;
		margin: 0 auto;	
	}
	
	h4.receiver-info-title-my {
	  padding-left: 10px;
	}
	...
	#goods_detail_class {width:1000px;}
.location-box-phone{float:left; border:1px solid #a6a6a6; padding:0 0 0 5px; position:relative; margin-left:10px; margin-top:0; background:none;}
.location-box-phone input{width:185px; color:#afafaf; height: 14px;line-height: 14px;padding: 3px 5px 3px 0;}
...
<div class="shopping-cart-box">
    ...
    <div class="shopping-cart-main roaw1210 w1210">
        ...
        <div class="my-shopping-cart ">
            <!-- 收货人开始-->
        	<h4 class="receiver-info-title receiver-info-title-my">
		    	收货人信息<a href="${base}/member/receiver.action" target="_blank" class="order-popup" >收货地址管理</a>
            ...
            <div class="my-shopping-cart-list mt-1 clearfix clear">
                ...
                <div class="leave-message">
                    ...
                    <div class="location-box-phone" style="background:none;">
