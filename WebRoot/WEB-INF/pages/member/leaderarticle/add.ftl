...
<head> 
 ...
 <div class="main_contents_v">
  <!-------------------------------------- 编辑器_START ----------------------------------------------------------------------------------->
  <div class="new_editor_start">
  
  <!-- 文章标题 -->
  <div class="article_title"><input type="text" id="title" class="art-value" maxlength="26" placeholder="请在此写下分享标题"/></div>
  <!-- 分享缩略图 -->
  <div class="article_title">
  	<div class="click-w">
        <input unselectable="on" type="file" name="imgfile" id="imgfile">
        <span id="headImageTip">上传图片</span><div class="health-close" id="shareImageUrlClose"></div>
        <input type="hidden" value="" id="share_image_url"/>
    </div>
  </div>
  <!-- 分享语 -->
  <div class="article_title"><input type="text" class="art-value" maxlength="36" value="" id="share_title" placeholder="请在此写下分享语"/></div>
  <!-- 分享语 -->
  <div class="article_title"><span class="art-value" id="select_goods_id">选择商品</span></div>
  
  <ul class="selected_goods_list"></ul>
