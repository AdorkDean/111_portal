...
<div class="my-articles w1000 clearfix my-articles-edit" style="margin-top:25px;">
		<form name="form1" id="form1"  action="/leaderarticle/leaderarticle!leaderArticleList.action" method="post">
    ...
    <div class="articles-left-nav">
        <ul>
           <li class="nav-edit"><a href="/leaderarticle/leaderarticle!add.action">写文章</a></li>
            ...
            <li class="current"><a  href="${base}/leaderarticle/leaderarticle!leaderArticleList.action"><span>我的文章</span><b>${myArticleCount?default(0)}</b></a></li>
    ...
    <#list pw.result?if_exists as resc>
        <div class="articles-list">
            ...
            <p class="health-time"><#if resc.createDt?exists>${resc.createDt?string('yyyy-MM-dd HH:mm:ss')}</#if></p>
            <div class="comment-num clearfix">
                <ul class="operation-btn">
                    ...
                    <li class="share"><b></b><a href="#" onclick="shareData('${resc.id}','${resc.title?default('')}','1')">分享</a></li>
                    <li class="delete"><b></b><a href="#" onclick="javascript:deleteMyArticle('${resc.id?default(0)}')">删除</a></li>
                </ul>
            </div>
        </div>
     </#list>
    ...
    <!-- 缺省页开始-->
  	<div class="health-default">
        <p class="default-shopping">还没有文章可分享，快去<a href="${base}/leaderarticle/leaderarticle!add.action">添加</a>吧～</p>
    </div>
    <!-- 缺省页结束-->
   </#if>
</div>
		...
		$confirm("warn","您确定要删除该文章吗?",null,function(result)
			  {
			    if(result)
			    {
					...
					if(data==1){
						$alert("warn","删除成功！");
						location.href="/leaderarticle/leaderarticle!leaderArticleList.action";
						return false;
					}else if(data==2){
						$alert("warn","删除失败！");
						location.href="/leaderarticle/leaderarticle!leaderArticleList.action";
