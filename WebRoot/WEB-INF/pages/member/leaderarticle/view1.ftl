...
<article class="recommend-shopping">
    <!--header class="rcm-header"><b class="rcm-line b-left"></b><h2 class="rcm-title">值得推荐</h2><b class="rcm-line b-right"></b></header-->
    <div class="rcm-list" id="tuijianContent">
    
    	<#list datas?if_exists as resc>
        <dl class="clearfix" id="goods_${resc_index+1}">
            <dt class="rcm-img clearfix"><a><img src="http://img.zdfei.com/${resc.imgurl}" alt="" height="125" width="125"/></a></dt>
            <dd class="rcm-text">
                ...
                <p class="shopping-price"><span>¥<i>${resc.wap_price?default(0)}</i></span><a>立即结算</a></p>
            </dd>
...
<div class="health-more">
    <a class="clearfix" onclick="window.location.href='http://m.111yao.com';"><p>更多好药</p><span>111医药馆</span></a>
</div>
-->
<!--微信开始-->
<div class="wx-img">
    <ul class="wx-top clearfix">
		<li><img src="images/health_wx01.jpg" alt="" id="wx-img"/></li>
...
<script>
var baseurl = "http://testwap.111yao.com";
$(function()
{
	$.post("/artic/artic!addLookSum.action?articleId="+${tla.id},{random:Math.random()}, function(data){});
	var url = document.location.href;
	var urlarray = url.split("com");
	var aimUrl = urlarray[1];
	//微信认证初始化	
	$.ajax(
	{
	    url: "/wx/wechat!getSignInfoFromRemote.action?signUrl="+encodeURIComponent(aimUrl),
		type: "GET",
		cache: false,
		async: false,
...
$(function()
{
  	...
  	$("#tuijianContent").find("dl").each(function(index)
  	{
  		$(this).click(function()
  		{
  			var i = index + 1;
...
function initWX()
{
	...
	var urlarray = url.split("com");
	var aimUrl = urlarray[1];
	if(aimUrl.indexOf("?from") > 0)
	{
		var aimUrlArray = aimUrl.split("?from");
		aimUrl = aimUrlArray[0];
	}
	aimUrl = baseurl + aimUrl;
	...
	wx.ready(function(){
		...
		wx.onMenuShareAppMessage({
		    ...
		    success: function ()
		    { 
				$.post("/artic/artic!clickLeaderArticleShareSum.action?articleId=${tla.id}",{random:Math.random()}, function(data){});
		    },
		    cancel: function (){ 
		    }
		});
