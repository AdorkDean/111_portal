...
<div class="my-pharmacy-page w1000">
		<form name="form1" id="form1"  action="${base}/leaderarticle/leaderarticle!leaderPharmacy.action" method="post">
    ...
    <h2 class="article-page-top">我的药房 <a href="${base}/leaderarticle/leaderarticle!leaderPharmacyGoodsList.action" class="add-shop">添加商品</a></h2>
    <#if (pw.result?size>0)>
            ...
            <li class="goodlist">
                ...
                <dl>
                    ...
                    <ul class="operation-btn">
                        <li class="delete"><b></b><a href="#" onclick="javascript:deleteMyPharmacyGoods('${resc.id?default(0)}')">删除</a></li>
                    </ul>
                    </dt>
                </dl>
            </li>
...
<!--分页结束-->
  ...
  <div class="health-default">
        <p class="default-shopping">还没有商品可显示，快去<a href="${base}/leaderarticle/leaderarticle!leaderPharmacyGoodsList.action">添加</a>吧～</p>
    </div>
    <!-- 缺省页结束-->
   </#if>
</div>
...
{
		$confirm("warn","您确定要删除该商品吗?",null,function(result)
			  {
			    if(result)
			    {
			 	   $.ajax({
				    url: "${base}/leaderarticle/leaderarticle!delPharmacyGoods.action",
				    type: "GET",
				 	data: {
					...
					if(data==1){
						...
						setTimeout(function()
						{
							location.href="/leaderarticle/leaderarticle!leaderPharmacy.action";
						}, 1500);
						return false;
					}else{
